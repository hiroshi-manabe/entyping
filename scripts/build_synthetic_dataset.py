...
DEFAULT_CSV = Path("content/synthetic/source/jhs1_typing_500_sentences.csv")
DEFAULT_OUTPUT = Path("content/synthetic/content.json")
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Build the synthetic JHS 1 Typing 500 runtime JSON."
    )
